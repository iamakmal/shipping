        ...
        <div className="bg-[#5D6C83] mt-20 p-8">
            ...
            <footer className="footer p-10 bg-[#5D6C83] text-white">
                <nav>
                    ...
                    <p className="text-md text-gray-300 my-5">Lorem ipsum dolor sit amet, consectur adipising elit.</p>
                    <h5 className="text-md text-gray-300 flex items-center"> <PhoneIcon className="h-4 w-4 mr-2"/>| (+94) 11 434 7575</h5>
                    <h5 className="text-md text-gray-300 flex items-center"><MapPinIcon className="h-4 w-4 mr-2"/>| 42 Lily Ave, Colobo 00600 </h5>
                </nav>
                <nav>
                    <h6 className="footer-title">Latest News</h6>
                    <p className="text-yellow mb-5">--------</p>
                    <p className="text-md text-gray-300 flex items-center"> <ChevronRightIcon className="h-4 w-4 mr-2 -mt-4 text-yellow"/> Seb ut perspicialtis unde omnis iste natus error sit volupatism <br/> 5 Minutes Ago</p>
                    <p className="text-md text-gray-300 flex items-center"> <ChevronRightIcon className="h-4 w-4 mr-2 -mt-4 text-yellow"/> Seb ut perspicialtis unde omnis iste natus error sit volupatism <br/> 5 Minutes Ago</p>
                </nav>
                <nav>
                    <h6 className="footer-title">Customer Service</h6>
                    <p className="text-yellow mb-5">--------</p>
                    <a className="link link-hover text-gray-300 flex items-center"><ChevronRightIcon className="h-4 w-4 mr-2 text-yellow"/>Support Forums</a>
                    <a className="link link-hover text-gray-300 flex items-center"><ChevronRightIcon className="h-4 w-4 mr-2 text-yellow"/>Communications</a>
                    ...
                    <a className="link link-hover text-gray-300 flex items-center"><ChevronRightIcon className="h-4 w-4 mr-2 text-yellow"/>Rules & Condition</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#5D6C83] text-white border-base-300">
                <aside className="items-center grid-flow-col">
                    <p>Copyright &copy; 2021 All Rights Reserved. Site By Xiteb&reg;</p>
                </aside>
